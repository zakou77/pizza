...
public class ControllerPizzaSwing {
    ...
    private final List<String[]> profils; // ✅ ajouté ici

    private Commande commande;
    private int numeroCommande = 1;

    public ControllerPizzaSwing(VuePizzaSwing vue, Point_Pizzaria pizzaria, Client client, Livreur livreur, List<Commande> historiqueCommandes, List<String[]> profils) {
        this.vue = vue;
        this.pizzaria = pizzaria;
        this.client = client;
        this.livreur = livreur;
        this.historiqueCommandes = historiqueCommandes;
        this.profils = profils; // ✅ stocké
    ...
    private void payerCommande() {
        ...
        // 🎁 Pizza offerte après vérification du solde
        if (totalPayantes >= 10) {
        ...
        // Paiement après ajout du bonus (si applicable)
    ...
    private void retourAccueil() {
        ...
        new ControlerClient(vueClient, client, pizzaria, livreur, historiqueCommandes, profils); // ✅ profils bien transmis
    }
}
